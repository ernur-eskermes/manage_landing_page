document.addEventListener("DOMContentLoaded", function() {
    var script = document.getElementById('6eafcc413f2804c0d877d417927262b1b2a8140a');
    ...
    iframe.className = '506';
	iframe.id = '87c27c2ee8d8a9f052db337fafd1b54021a5b2ec' + '_' + iframe.className;
	...
	var gcEmbedOnMessage = function(e) {
		...
		if (e.data.uniqName == '6eafcc413f2804c0d877d417927262b1b2a8140a') {
			if (e.data.height) {
